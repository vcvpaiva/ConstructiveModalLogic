...
The following lemma summarizes the symmetric monoidal structure in a
cartesian closed category whose proof is well known.
...
As we can see from the previous definition cartesian products are less
strict than arbitrary tensor products.  We can capitalize on this fact
