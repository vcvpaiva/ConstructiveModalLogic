...
%this section is here just so I don't forget it 
\subsection{Heyting algebras with adjunctions HAA}
%Need to define HAA (Heyting algebras with adjunctions) and see if we can show a reasonable duality theorem similar to Menni and Smith's corollary 3.5
