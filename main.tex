...
single-conclusion formalization of Gentzen's LK which produces
intuitionistic sequent calculus.  The syntax of formulas for LK is
...
Bierman and de Paiva \cite{CS4}.  The following rules in addition to
