...
\begin{proof}
  ...
  \item[] Case.\\
    ...
    \langle f_1,\ldots,f_k \rangle$, where $\langle -,-\rangle :
    \mathsf{Hom}_{\cat{C}}(C,A_1) \times \cdots \times
    \mathsf{Hom}_{\cat{C}}(C,A_k) \mto \mathsf{Hom}_{\cat{C}}(C,A_1
    \times \cdots \times A_k)$ exists because $\cat{C}$ is cartesian.
  \end{itemize}
