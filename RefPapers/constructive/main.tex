...
\renewcommand{\TLLdruletyXXdiaIName}{\Diamond_\mathcal{I}}
\renewcommand{\TLLdruletyXXdiaEName}{\Diamond_\mathcal{E}}
\renewcommand{\TLLdruletyXXbdiaIName}{\blacklozenge_\mathcal{I}}
\renewcommand{\TLLdruletyXXbdiaEName}{\blacklozenge_\mathcal{E}}
\renewcommand{\TLLdruletyXXadjLName}{adj_\mathcal{L}}
\renewcommand{\TLLdruletyXXadjRName}{adj_\mathcal{R}}
%% End Ott
...
\end{itemize}
Ewald and most of the researchers that followed his path of constructivization of tense logic, did so assuming a symmetry between
past and future. This symmetry, as well as the symmetry between
universal and existential quantifiers, both in the past and in the future, are somewhat at odds with intuitionistic reasoning.
...
A version of a  sequent calculus  system for this constructive tense logic is given by the rules in Figure \ref{fig:biCS4}, which can be easily transformed into Natural Deduction in the style of \cite{bierman2000} as shown in Figure \ref{}. A natural deduction version of the calculus in dual context style is given in Figure \ref{fig:TCS4}.
...
\begin{figure}
  \begin{mdframed}
    ...
    \end{center}
  \end{mdframed}
  \caption{Constructive tense S4 sequent rules  ({\sf{biCS4}})}
  \label{fig:biCS4}
\end{figure}
...
\begin{figure}
  \begin{mdframed}
    ...
    \end{center}
  \end{mdframed}
  \caption{Constructive  S4 rules ND version ({\sf{biCS4}})}
  \label{fig:NDCS4}
\end{figure}
      ...
      \begin{math}
        \begin{array}{l}
          ...
          \begin{array}{ccccc}              
            ...
            & \quad &
            \infer[\Diamond_{\mathcal{E}}]{\Gamma_1; \Gamma_2;\Delta \vdash \Diamond B}{
              \Gamma_1; \Gamma_2 ;\Delta \vdash \Diamond A \hspace{.1in}\Gamma; A\vdash \Diamond B
            }
          \end{array}    
        \end{array}
      \end{math}
